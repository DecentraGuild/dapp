<template>
  <div class="base-button-dropdown" :class="dropdownClasses">
    <!-- Trigger Button (styled like original nav buttons) -->
    <button
      ref="triggerRef"
      ...
      :style="buttonStyles"
    >
      <Icon :icon="icon" class="button-icon" />
...
interface Props {
  items: DropdownItem[]
  modelValue?: DropdownItem | string | number | null
  placeholder?: string
  icon: string
  buttonText?: string
...
const selectedText = computed(() => {
  if (selectedItem.value) {
    return selectedItem.value.title || selectedItem.value.name || selectedItem.value.label
  }
  return props.buttonText || props.placeholder
})
